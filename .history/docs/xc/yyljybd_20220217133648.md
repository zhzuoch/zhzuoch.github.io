...
<table>
    ...
    <tr align="center">
        ...
        <td>总分式</td>
    	<td>通常为总分、分总、总分总形式，重点关注首尾句，理清首尾句与其他内容之间的结构关系</td>
    </tr>
    <tr align="center">
        <td>转折式</td>
    	<td>转折之后的内容是文段论述的重点需准确理解，排除论述转折之前内容的选项</br></td>
    </tr>
    <tr align="center">
    ...
    <tr align="center">
        <td>强调词</td>
    	<td>作者为表达自己观点时，常常使用语气比较重的词语，其所在句子通常为文段重点</br></td>
    </tr>
    <tr align="center">
    	<td>推断隐含信息型</td>
    	<td colspan="3">作者观点不能直接从材料中得出，解答此类题目的关键在于基于原文合理推断，pai'chu</td>
    </tr>
</table>