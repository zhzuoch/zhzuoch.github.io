...
$$基期平均数=\frac{基期总量}{基期份数}=\frac{\frac{A}{1+q_A}}{\frac{B}{1+q_B}}=\frac{A}{B}\cdot\frac{1+q_B}{1+q_A}\tag{6}$$
...
$$隔年增长率q=\left(1+q_1\right)\cdot\left(1+q_2\right)-1={q_1+q_2+q_1\cdot\\q_2}\tag{11,3★}$$
$$隔年基期值=\frac{A}{\left(1+q_1\right)\cdot\left(1+q_2\right)}=\frac{A}{1+q_1+q_2+q_1\cdot\\q_2}\tag{12,4★}$$