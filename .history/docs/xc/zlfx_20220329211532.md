...
$$\because X\%\uparrow\longrightarrow\frac{1}{X\%}\downarrow\longrightarrow\frac{1+X\%}{X\%}\downarrow\longrightarrow\frac{X\%}{1+X\%}\uparrow$$
$$\therefore 增长量的大小比较=整体值\cdot 各自比重\tag{4}$$
...
$$隔年增长率q=(1+q_1)\cdot(1+q_2)-1={q_1+q_2+q_1\cdot\\q_2}\tag{12,3★}$$
$$隔年基期值=\frac{A}{(1+q_1)\cdot(1+q_2)}=\frac{A}{1+q_1+q_2+q_1\cdot\\q_2}\tag{13,4★}$$
...
注：如果提到2012-2015年的年均增长量或年均增长率等，一般不考虑2012年的增长情况（江苏例外）；但是如果提到2012-2015年增长最快/最多的年份，一般都是要考虑2012年当年的增长情况的，否则会使得很多国考省考题目变得没有答案
